            ...
            <div class="title"><span class="title_icon"><?php echo $this->Html->image('bullet1.gif', array('alt' => '')); ?></span><?php echo $category; ?>
			<p class="details"><?php echo '» Số lượng: ', $ebook_count, ' ebooks'; ?></p></div>
			<?php if(!empty($searchbooks)) {
				foreach($searchbooks as $ebook):
				...
				endforeach;
					...
					echo '<div class="feat_prod_box">Không tìm thấy sách nào trong mục này.</div>';
				}
			?>
